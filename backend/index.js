...
app.post('/bfhl', async (req, res) => {
    ...
    const response = {
        is_success: true,
        user_id: "Shivansh_Tiwari_10082003", // Replace with your format dynamically
        email: "st5239@srmist.edu.in", // Replace with the correct email
        roll_number: "RA2111003030438", // Replace with the actual roll number
        numbers,
        alphabets,
